...
export let updateUserDetails = (userId: string, updateUserDetails: User) =>
    new Promise((resolve, reject) => {
        User.findById(userId)
            .then((user: UserDocument) => {
                ...
                user.save().then((updatedUser: UserDocument) =>
                    resolve(updatedUser)
                );
            })
            .catch((error: any) => {
...
export let updateUserPassword = (userId: string, password: string) =>
    new Promise((resolve, reject) => {
        User.findById(userId)
            .then((user: UserDocument) => {
...
export let deleteUser = (userId: string) =>
    new Promise((resolve, reject) => {
